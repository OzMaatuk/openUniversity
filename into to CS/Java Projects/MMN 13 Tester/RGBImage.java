...
public class RGBImage extends RGBColor
{
    ...
    {
        RGBColor [][] helpObj = new RGBColor[_image[0].length][_image.length];
    ...
    {
        RGBColor [][] helpObj = new RGBColor[_image.length][_image[0].length];
    ...
    {
        RGBColor[][] copy_image = new RGBColor[_image.length][_image[0].length];
        for (this._rows=0; this._rows<_image.length; this._rows++)
        {
            for (this._cols=0; this._cols<_image[0].length; this._cols++)
            {
